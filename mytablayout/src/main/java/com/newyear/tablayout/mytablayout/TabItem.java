...
public final class TabItem extends View {
    ...
    public TabItem(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabItem);
        mText = attributes.getText(android.support.design.R.styleable.TabItem_android_text);
        mIcon = attributes.getDrawable(android.support.design.R.styleable.TabItem_android_icon);
        mCustomLayout = attributes.getResourceId(android.support.design.R.styleable.TabItem_android_layout, 0);
        attributes.recycle();
    }
}